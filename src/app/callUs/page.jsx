    ...
    <div className={"w-[85%] m-auto mt-12"}>
      ...
      <section className={'mt-24'}>
        <div className={'flex items-center gap-x-2'}>
          ...
          <h4 className={'text-4xl'}>Contáctanos</h4>
      ...
      <section className='flex justify-between items-center gap-x-8'>
        <div className='w-1/2'>
          <div className={Danareg.className}>
            <p className='text-justify text-sm mb-10'>Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de texto. Lorem Ipsum ha sido el texto de relleno estándar de las industrias desde el año 1500, cuando un impresor desconocido usó una galería de textos y los mezcló de tal manera que logró hacer un libro de textos especimen. No sólo sobrevivió 500 años, sino que también ingresó como texto de relleno en documentos electrónicos, quedando esencialmente igual al original.</p>
          </div>
          {/* ADDRESS */}
          <div className='grid grid-cols-8 gap-4'>
            <div className='shadow-xl w-auto rounded-lg bg-zinc-200 flex items-center p-8 col-start-1 col-end-4 h-2/3'>
              <div>
                <Image src={"./img/callus/email-svgrepo-com (1).svg"} width={50} height={50} alt='' className='p-1' unoptimized />
              </div>
              <div className='p-2'>
                <div className={Danareg.className}>
                  <h5 className='font-bold'>Correo electrónico:</h5>
            ...
            <div className='shadow-xl w-auto rounded-lg bg-zinc-200 flex items-center p-8 col-start-4 col-end-7 h-2/3'>
              <div>
                <Image src={"./img/callus/call-ringing-svgrepo-com (2).svg"} width={60} height={60} alt='' unoptimized />
              </div>
              <div className={Danareg.className}>
                <h5 className='font-bold'>Teléfono de contacto:</h5>
          ...
          <div className='grid grid-cols-8 gap-4'>
            <div className='shadow-xl w-auto rounded-lg bg-zinc-200 flex items-center p-8 col-start-2 col-end-5 h-2/3'>
              <div>
                <Image src={'./img/callus/map-marker-2-svgrepo-com.svg'} width={60} height={60} alt='' className='mr-1' unoptimized />
              </div>
              <div className={Danareg.className}>
            ...
            <div className='shadow-xl w-auto rounded-lg bg-zinc-200 flex items-center p-8 col-start-5 col-end-8 h-2/3'>
              <div>
                <Image src={'./img/callus/whatsapp-svgrepo-com.svg'} width={60} height={60} alt='' className='p-1' unoptimized />
              </div>
              <div className={Danareg.className}>
                <h5 className='p-1 font-bold'>شبکه های اجتماعی: </h5>
                <div className='flex items-center justify-start p-2'>
                  <Image src={'./img/callus/send-2.svg'} alt='' width={18} height={18} className='mr-2 hover:scale-125 cursor-pointer duration-300' unoptimized />
                  <Image src={'./img/callus/facebook.svg'} alt='' width={18} height={18} className='mr-2 hover:scale-125 cursor-pointer duration-300' unoptimized />
                  <Image src={'./img/callus/whatsapp.svg'} alt='' width={18} height={18} className='mr-2 hover:scale-125 cursor-pointer duration-300' unoptimized />
                  <Image src={'./img/callus/youtube.svg'} alt='' width={18} height={18} className='mr-2 hover:scale-125 cursor-pointer duration-300' unoptimized />
                </div>
              </div>
            </div>
          </div>
        ...
        <div>
          <Image src={'/img/Blog/Group-88-min.png'} alt='' width={600} height={600} unoptimized />
        </div>
      </section>
