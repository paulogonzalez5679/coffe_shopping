            ...
            <div className={'w-[85%] m-auto text-white '}>
                ...
                <div className={'flex justify-between items-start pt-10'}>
                    ...
                    <div className={'w-[325px]'}>
                        <Image src="./img/Group-796.svg" className={'w-[267px] h-[63px] mb-4'} alt="" width={1000} height={1000} unoptimized/>
                    ...
                    <div className={'w-[262px]'}>
                        ...
                        <div className={'flex justify-between mt-5'}>
                            <Image className={'mt-5 w-[90px] h-[90px] rounded-2xl'} src={'/img/Group-42.jpg'} alt={'ee'} width={'1000'} height={'1000'} unoptimized></Image>
                            <Image className={'mt-5 w-[90px] h-[90px] rounded-2xl'} src={'/img/Group-42.jpg'} alt={'ee'} width={'1000'} height={'1000'} unoptimized></Image>
                        </div>
                    </div>
                </div>
